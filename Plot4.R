...
##  This script will creat plot Graph 4 for Exploratory Data Analysis, project 1.
...
plot(EPC_data2$Date_Time, EPC_data2$Global_active_power, type = "l", 
...
plot(EPC_data2$Date_Time, EPC_data2$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

plot(EPC_data2$Date_Time, EPC_data2$Global_reactive_power, type = "l", xlab = "datetime", 
     ylab = "Global_reactive_power")

## Save Graph 4 as a png file.
